...
label devel:
    ...
    dev "Главный координатор и шеф, он же босс : {color=FF0000}Хан ( Khan ){/color}"
    dev "Главный разработчик, сценарии, порождение и фикс багов : {color=00FF00}Дрон (Dron){/color}"
    ...
    dev "Сценарии и идеи : {color=008900}Tobie{/color}"
