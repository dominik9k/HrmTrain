...
translate english start_18432091:
    ...
    ">Transfer of [persistent.gold] galleons complete."
...
translate english start_e0040ea0:

    # m "И вообще, игра еще не началась, а ты уже занимаешься самовставками, при том, что работы сделал с гулькин нос."
    m "The game did not start yet and you are already making self-insert comments but did less work then nothing."
...
translate english start_dcab8870:
    ...
    m "And what is all about the red colour of your nickname?"
...
translate english start_7b68f41d:
...
translate english strings:
    ...
    old "Дай мне чит!"
    new "Yes, activate the cheating mode."

    # game/script.rpy:5533
    old "Нет, читеры должны гореть в аду!"
    new "No, cheaters burn in Hell!"

    # game/script.rpy:5544
    old "Вы желаете пропустить интро?"
    new "Would you like to skip the Intro?"
    ...
    # game/script.rpy:5544
    old "Пропустить интро."
    new "Skip the Intro"

    # game/script.rpy:5544
    old "Перейти сразу на утро после дуэли."
    new "Jump to the morning after the duel."
    ...
    new "Are you sure you want to delete the save?"

    # game/script.rpy:555
    old "Вы уверены, что хотите перезаписать это сохранение?"
    new "Are you sure you want to overwrite this save?"

    # game/script.rpy:556
    old "После загрузки вы потеряете весь текущий прогресс.\nВы уверены, что хотите сделать это?"
    new "After loading, you will lose all your current progress.\nAre you sure you want to do this?"
    ...
    new "Are you sure you want to exit to the main menu?\nThis will lead to the loss of your current progress."

    # game/script.rpy:559
    old "Вы уверены, что хотите начать пропуск текста?"
    new "Are you sure you want to start skipping the text?"

    # game/script.rpy:560
    old "Вы уверены, что хотите пропустить следующий выбор?"
    new "Are you sure you want to skip the next choice?"
