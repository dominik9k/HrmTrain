...
label dap_request_01_complete:
    ...
    if IsRunNumber(1):
        ...
        $daphne("~55 00 1 ope// Да, это так, сэр! Такой чистой крови ни у кого нет - не только в Хогвартсе, но и в Дурмшанге.// ~55 c0 1 ope// Мы - Гринграссы, ведем свой род от самого Салазара Сли...")
        ...
        $hero("...есть три пути увеличения популярности.//"
            "Как я понимаю: за вас - кровь, против вас - результаты в учебе.//"
            "Остаются мужчины - они могут склонить чашу весов в ту или иную сторону.")
        ...
        $hero("Наверное, все-таки не очень хорошо. Напомните, пожалуйста, какие качества отличают слизеринцев")
